...
class ForecastServiceTest {
    ...
    void testGetForecast_returnsForecastFromHandler() throws Exception {
        ...
        doAnswer(invocation -> {
            ...
            req.setForecast(new Forecast(0.75f, new Municipality(municipalityId, new Coordinates(1, 2)), new Municipality(municipalityId, new Coordinates(1, 2))));
            return null;
    ...
    void testGetForecastForAllMunicipalities_handlesAllMappingsAndFiltersNulls() throws Exception {
        ...
        MunicipalityToCluster mapping1 = new MunicipalityToCluster(munA.getName(), "cluster1", "cluster3");
        MunicipalityToCluster mapping2 = new MunicipalityToCluster(munB.getName(), "cluster2", "cluster4");
        ...
        assertEquals("A", result.getFirst().getMunicipality().getName());
    }
}